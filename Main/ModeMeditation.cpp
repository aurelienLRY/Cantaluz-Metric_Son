...
static const MedProfile MED_PROFILES[] = {
  { MEDIT_DUR_1MIN_SEC,  MEDIT_P0_INSPIRE_SEC, MEDIT_P0_HOLD_SEC, MEDIT_P0_EXPIRE_SEC, MEDIT_P0_HOLD_EMPTY_SEC, MEDIT_P0_PAUSE_SEC },
  { MEDIT_DUR_2MIN_SEC,  MEDIT_P1_INSPIRE_SEC, MEDIT_P1_HOLD_SEC, MEDIT_P1_EXPIRE_SEC, MEDIT_P1_HOLD_EMPTY_SEC, MEDIT_P1_PAUSE_SEC },
  { MEDIT_DUR_5MIN_SEC,  MEDIT_P2_INSPIRE_SEC, MEDIT_P2_HOLD_SEC, MEDIT_P2_EXPIRE_SEC, MEDIT_P2_HOLD_EMPTY_SEC, MEDIT_P2_PAUSE_SEC },
};
...
static int medProfileIndexFromDur(uint16_t durSec) {
  if (durSec <= MEDIT_DUR_1MIN_SEC + 15) return 0;
  if (durSec <= MEDIT_DUR_2MIN_SEC + 15) return 1;
  return 2;
}
